...
Integration tests should be used frugally only for main happy path scenario, or when it takes a lot of efforts to mock 
all dependencies. Mostly that's because they are expensive to run.
