...
* In-query fusion in hybrid search. Count the legs' union in round 1 so a default-totals request drops round 2's Tail ([#2029](https://github.com/opensearch-project/neural-search/pull/2029))
