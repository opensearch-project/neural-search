...
### Bug Fixes
* Align ML Commons FunctionName in inference requests with the algorithm configured in the registered model ([#1885](https://github.com/opensearch-project/neural-search/pull/1885))
