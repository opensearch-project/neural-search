...
* In-query fusion in hybrid search. Support `rrf` in fused mode as a normalizer over ranks, computing rank scores through the same code as the score-ranker-processor, and read rank_constant from the combination clause rather than combination.parameters ([#1948](https://github.com/opensearch-project/neural-search/pull/1948))
