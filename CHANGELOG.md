...
### Bug Fixes
* [Hybrid Query] Fix unreachable non-competitive score check in HybridCollapsingTopDocsCollector while keeping totalHits accurate ([#1795](https://github.com/opensearch-project/neural-search/issues/1795))
