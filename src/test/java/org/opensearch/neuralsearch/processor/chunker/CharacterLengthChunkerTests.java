...
import static org.opensearch.neuralsearch.processor.chunker.CharacterLengthChunker.CHAR_LIMIT_FIELD;
import static org.opensearch.neuralsearch.processor.chunker.CharacterLengthChunker.OVERLAP_RATE_FIELD;

public class CharacterLengthChunkerTests extends OpenSearchTestCase {
    ...
    public void testParseParameters_whenNoParams_thenSuccessfulUsesDefaults() {
        CharacterLengthChunker chunker = new CharacterLengthChunker(Map.of());
    ...
    public void testParseParameters_whenIllegalLengthLimitType_thenFail() {
        ...
        IllegalArgumentException illegalArgumentException = assertThrows(
            ...
            () -> new CharacterLengthChunker(parameters)
        );
        assertEquals(
    ...
    public void testParseParameters_whenIllegalLengthLimitValue_thenFail() {
        ...
        illegalArgumentException = assertThrows(IllegalArgumentException.class, () -> new CharacterLengthChunker(parameters));
        assertEquals(
            String.format(Locale.ROOT, "Parameter [%s] must be positive.", CHAR_LIMIT_FIELD),
            illegalArgumentException.getMessage()
        );
