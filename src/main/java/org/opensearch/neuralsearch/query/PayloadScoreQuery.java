...
public class PayloadScoreQuery extends SpanQuery {
    ...
    private final Map<String, Float> termWeights;
    ...
    public Query rewrite(IndexSearcher indexSearcher) throws IOException {
        ...
        if (wrappedQuery != matchRewritten && matchRewritten instanceof SpanQuery) {
            return new PayloadScoreQuery((SpanQuery) matchRewritten, function, decoder, includeSpanScore, termWeights);
        }
    ...
    private class PayloadSpans extends FilterSpans implements SpanCollector {
        ...
        public void collectLeaf(PostingsEnum postings, int position, Term term) throws IOException {
            ...
            payloadFactor = payloadFactor*PayloadScoreQuery.this.termWeights.get(term.bytes().utf8ToString());
            payloadScore =
