...
public class SemanticFieldMapper extends ParametrizedFieldMapper {
    ...
    public static class Builder extends ParametrizedFieldMapper.Builder {
        ...
        @Getter
        protected final Parameter<Boolean> reuseExistEmbedding = Parameter.boolParam(
            REUSE_EXIST_EMBEDDING,
            true,
            m -> ((SemanticFieldMapper) m).semanticParameters.getReuseExistEmbedding(),
            false
        );
        ...
        public SemanticParameters getSemanticParameters() {
            return SemanticParameters.builder()
                ...
                .reuseExistEmbedding(reuseExistEmbedding.getValue())
                .build();
        }
    }
