...
public class SemanticStringFieldType extends StringFieldType {
    ...
    public SemanticStringFieldType(@NonNull final StringFieldType delegateFieldType, @NonNull final SemanticFieldMapper.Builder builder) {
        super(
        ...
        this.semanticFieldTypeParameters = new SemanticFieldTypeParameters(builder);
    }
