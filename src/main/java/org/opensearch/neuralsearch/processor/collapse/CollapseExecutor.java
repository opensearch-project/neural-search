...
public class CollapseExecutor {
    ...
    public int executeCollapse(CollapseDTO collapseDTO) {
         ...
         * As per current code, if the group value is null when the document does not have collapse field then we cannot determine the field type.
         * TODO: In future, when collapseContext is accessible then retrive fieldType from there.
         *
         */
